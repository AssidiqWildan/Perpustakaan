...
<br><br>
	...
	<table width="100%"  class="table table-condensed">
		...
		<tr>
			...
			<td>(<?=str_pad($b->nim_nidn, 3, '0', STR_PAD_LEFT)?>) - <?=$b->nama?><br><b><?=$b->jk?></b></td>
			<td><?=$b->tmp_lahir?>, <?=tgl_panjang($b->tgl_lahir, "sm")?></td>
			<td><?=$b->alamat?></td>
			<td><?=$b->jenis?>, <?php if ($b->stat == "1") { echo "Aktif"; } else { echo "Non Aktif"; }?>, <a href="<?=base_URL()?>apps/anggota/list_pinjam/<?=$b->nim_nidn?>">Riwayat Pinjam</a></td>
			
			<td style="text-align: center">
			<a href="<?=base_URL()?>apps/anggota/edt/<?=$b->nim_nidn?>"><span class="icon-pencil">&nbsp;&nbsp;</span></a>  
			<a href="<?=base_URL()?>apps/anggota/del/<?=$b->nim_nidn?>" onclick="return confirm('Anda YAKIN menghapus data \n <?=$b->nama?>..?');"><span class="icon-remove">&nbsp;&nbsp;</span></a>
			</td>
		</tr>	
		<?php 
			}
