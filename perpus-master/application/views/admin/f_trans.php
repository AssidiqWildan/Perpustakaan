<form action="<?=base_URL()?>apps/trans/act_add" method="post" accept-charset="utf-8" enctype="multipart/form-data" name="f_trans" onsubmit="return cek()">	
	...
	<div class="well">
	<label style="width: 150px; float: left">ID Anggota</label><input class="span2" type="text" name="id_anggota" value="<?=$det_anggota->nim_nidn?>"required readonly> &nbsp;<input class="span4" type="text" name="nama" value="<?=$det_anggota->nama?>" readonly><br>
	...
	<label style="width: 150px; float: left">Tanggal Kembali</label><input class="span2" type="date" name="tgl_kembali" value="<?=adddate(7)?>"><br>
