...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_URL('aset/js/statistic/chartist.min.css') ?>">
    <script src="<?php echo base_URL('aset/js/statistic/chartist.min.js') ?>"></script>
  ...
  <body>
    ...
    <div class="navbar navbar-inverse navbar-fixed-top" style="background: #CBD9BC">
      	<div style="margin-left: 20px">
			<img style="width: 70px; height: 70px; display: inline; float: left; margin-right: 20px" src="<?php echo base_URL('aset/'.$q_instansi->logo) ?>">
			<h3>Universitas Faletehan</h3>
        ...
        <div class="container-fluid">
          ...
          <div class="nav-collapse collapse">
            ...
            <ul class="nav">
              <?php 
			            $m_view	= array("Home", "Transaksi", "Data Anggota", "Data Buku", "Tools", "Kelola User");
			            $m_val	= array("", "trans", "anggota", "buku", "tool", "Kelola");
